...
需要进一步补充 IndexScan 功能实现：
- scalar function: vec_distance_l2
- HNSWIndexScanRule

**scalar function**

支持 `vec_distance_l2(n.vec, [0.1, 0.1,...])`

```c++
struct VecDistanceL2Function {
  static constexpr const char* name = "VEC_DISTANCE_L2";
...
在 zvec/extension 下增加 hnsw-index-scan 单元测试：
