...
CREATE REL TABLE HASCREATOR (FROM COMMENT TO PERSON, creationDate TIMESTAMP) WITH (sort_key_for_nbr = 'creationDate');
CREATE REL TABLE HASCREATOR (FROM POST TO PERSON, creationDate TIMESTAMP) WITH (sort_key_for_nbr = 'creationDate');
